...
export default function Home() {
  ...
  return (
    <>
      <main className="main">
        ...
        <section className=" revealed ">
          ...
          <Typography variant="body2">
            ...
            be subjects. In no impression assistance contrasted. Manners she
            ...
            dearest staying now sixteen nor improve. Yourself off its pleasant
            ecstatic now law. Ye their mirth seems of songs. Prospect out bed
            contempt separate. Her inquietude our shy yet sentiments collecting.
            Cottage fat beloved himself arrived old. Grave widow hours among him
            no you led. Power had these met least nor young. Yet match drift
            wrong his our. Drawings me opinions returned absolute in. Otherwise
            therefore sex did are unfeeling something. Certain be ye amiable by
            exposed so. To celebrated estimating excellence do. Coming either
            suffer living her gay theirs. Furnished do otherwise daughters
            contented conveying attempted no. Was yet general visitor present
            hundred too brother fat arrival. Friend are day own either lively
            new.
          </Typography>
        </section>
      ...
      <footer>Nunchakurest® Seyhak Ly ©</footer>
    </>
  )
}
